...
#SBATCH --job-name=post_relax
#SBATCH --output=post_relax.out
#SBATCH --error=post_relax.err
...
for formula_dir in "${formula_dirs[@]}"; do
    ...
    # If structures.db is present, files should have been extracted prior to
    # the relaxation step.

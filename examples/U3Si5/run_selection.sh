...
METHOD="hdbscan"        # Options: random, kmeans, medoid, maxmin, hdbscan
DESCRIPTOR="soap"    # Options: simple, soap (1D: soap only; 0D: +coulomb)
TARGET_COUNT=50        # Number of structures to keep (ignored for hdbscan)
